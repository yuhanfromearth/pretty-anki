...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 max-w-6xl mx-auto px-5 sm:px-8 pt-6 pb-4">
      <div className="flex items-center rounded-2xl bg-milk-100/80 backdrop-blur-sm border border-milk-300/40 px-5 py-3 shadow-soft">
        ...
        <div className="ml-auto flex items-center gap-1">
          {streak.data && (
            <div className="mr-2 flex items-center gap-2 rounded-full bg-milk-200/60 border border-milk-300/50 pl-1 pr-3.5 py-1 text-sm font-medium">
              <span className="flex size-7 items-center justify-center rounded-full bg-milk-400/60 text-xs font-semibold text-ink-700">
                {streak.data.days}
              </span>
